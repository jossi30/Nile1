      ...
      <div className="footer--link--container">
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=61561016184572"
            ...
            <li>
              <a
                href="https://x.com/NileMarketingA"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/nile-marketing-agency-261660294/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
